...
install_download() {
    ...
    wget https://github.com/JJMinerProxy/MinerProxy/blob/main/Linux-64/MinerProxy_Linux -O ./MinerProxy/MinerProxy_Linux
...
start_write_config() {
    ...
    echo "默认端口:1677 默认账号:admin 默认密码:admin123 访问管理界面:本机IP:16777"
    echo
    echo "安装完成"
    echo
    echo "后台默认端口:1677"
