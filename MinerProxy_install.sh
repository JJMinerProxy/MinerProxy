...
install_download() {
    ...
    wget https://raw.githubusercontent.com/JJMinerProxy/MinerProxy/main/Linux-64/MinerProxy_Linux -O ./MinerProxy/MinerProxy_Linux
...
start_write_config() {
    ...
    echo "默认端口:16777 默认账号:admin 默认密码:admin123 访问管理界面:本机IP:16777"
    echo
    echo "安装完成"
    echo
    echo "后台默认端口:16777"
    echo "后台默认账号:admin"
    echo "后台默认密码:admin123"
    echo "----------------------------------------------------------------"
}
...
while :; do
    echo
    echo "-------- MinerProxy 一键安装脚本 by:JJMinerProxy--------"
    echo "Github下载地址:https://github.com/JJMinerProxy/MinerProxy"
    echo "官方电报群:https://t.me/JJ_MinerProxy"
    echo "官方QQ群号:942989790"
    echo
